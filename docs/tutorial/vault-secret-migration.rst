...
The migration script is provided in the `openstack-migrate` repository under `misc/scripts/vault_migrate.sh <https://github.com/petrutlucian94/openstack-migrate/blob/main/misc/scripts/vault_migrate.sh>`_. Save the script to your local machine.
